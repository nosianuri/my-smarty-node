...
app.get('/', (req, res) => {
    res.send('Hello from my Smarty Smarty Pant!!! auto restart')
});

const users = [
    {id: 1, name: 'Sabana', email: 'sabana@gmail.com', phone: '0178888888'},
    {id: 2, name: 'Shabnoor', email: 'sabnoor@gmail.com', phone: '0178888888'},
    ...
    {id: 6, name: 'Sohana', email: 'Sohana@gmail.com', phone: '0178888888'},
    {id: 6, name: 'Saba', email: 'Saba@gmail.com', phone: '0178888888'},
]
